...
async fn main() {
    ...
    //     Some("projects") => {
    //         let response = Client::get_projects().await;
    //         match response {
    //             Ok(projects) => {
    ...
    //                             let response = Client::get_version_builds(project, v, b_i32).await;
    //                             match response {
    //                                 Ok(info) => {
    //                                     println!("Changes:");
    ...
    //                         }
    //                     } else {
    //                         let response = Client::get_version_info(project, v).await;
    //                         match response {
    //                             Ok(info) => {
    //                                 println!("Project ID:   \t{}", info.project_id);
    //                                 println!("Project Name: \t{}", info.project_name);
    ...
    //                     let response = Client::get_group_builds(project, g).await;
    //                     match response {
    //                         Ok(info) => {
    //                             if let Some(b) = build {
    //                                 let build_i32 = b.parse::<i32>();
    ...
    //                     }
    //                 } else if let Some(g) = group {
    //                     let response = Client::get_group_info(project, g).await;
    //                     match response {
    //                         Ok(info) => {
    //                             println!("Project ID:    \t{}", info.project_id);
    //                             println!("Project Name:  \t{}", info.project_name);
    ...
    //                     }
    //                 } else {
    //                     let response = Client::get_project(project).await;
    //                     match response {
    //                         Ok(project_info) => {
